...
describe('StorageService - 文件存储', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该成功删除所有文件', async () => {
      const files = [
        { id: 'file-1', name: 'test1.ts', content: 'c1', language: 'ts', path: '/p1', createdAt: Date.now(), updatedAt: Date.now(), size: 100 },
        { id: 'file-2', name: 'test2.ts', content: 'c2', language: 'ts', path: '/p2', createdAt: Date.now(), updatedAt: Date.now(), size: 200 },
      ]
  ...
  describe('文件统计', () => {
    it('应该正确统计文件信息', async () => {
      const files = [
        { id: 'file-1', name: 'test.ts', content: 'content1', language: 'typescript', path: '/p1', createdAt: Date.now(), updatedAt: Date.now(), size: 100 },
        { id: 'file-2', name: 'test.js', content: 'content2', language: 'javascript', path: '/p2', createdAt: Date.now(), updatedAt: Date.now(), size: 200 },
        { id: 'file-3', name: 'test.css', content: 'content3', language: 'css', path: '/p3', createdAt: Date.now(), updatedAt: Date.now(), size: 150 },
      ]
...
describe('StorageService - AI缓存', () => {
  ...
  describe('按模型查询', () => {
    it('应该成功按模型获取AI缓存', async () => {
      const caches = [
        { id: 'cache-1', prompt: 'p1', response: 'r1', model: 'gpt-4', createdAt: Date.now(), expiresAt: Date.now() + 60000, ttl: 60000, tokens: 100 },
        { id: 'cache-2', prompt: 'p2', response: 'r2', model: 'gpt-4', createdAt: Date.now(), expiresAt: Date.now() + 60000, ttl: 60000, tokens: 150 },
        { id: 'cache-3', prompt: 'p3', response: 'r3', model: 'gpt-3.5', createdAt: Date.now(), expiresAt: Date.now() + 60000, ttl: 60000, tokens: 120 },
      ]
