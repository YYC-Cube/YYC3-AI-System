...
class MCPClient {
  ...
  private setupHandlers(): void {
    this.protocolHandler.registerNotificationHandler('notifications/resources/updated', (params) => {
...
class MCPClientPool {
  ...
  async createClient(id: string, config: MCPClientConfig, transport: MCPTransport): Promise<MCPClient> {
