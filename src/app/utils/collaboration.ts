...
type AwarenessChangeHandler = (changes: { added: number[]; updated: number[]; removed: number[] }) => void
...
const SIMULATED_PEERS: CollabUser[] = [
  { id: 'peer-alice', name: 'Alice', color: '#6366f1', cursor: null, online: true, lastSeen: Date.now() },
  { id: 'peer-bob', name: 'Bob', color: '#f59e0b', cursor: null, online: true, lastSeen: Date.now() },
  { id: 'peer-carol', name: 'Carol', color: '#10b981', cursor: null, online: false, lastSeen: Date.now() - 300000 },
]
 ...
 */
export function bindYTextToState(
  yText: Y.Text,
