  ...
  switch (theme) {
    ...
    case 'midnight':
      return {
        ...
        base: 'slate',
        accentName: 'blue',
        appGradientFrom: 'rgba(59,130,246,0.25)',
        appGradientTo: 'rgba(255,255,255,0)',
        ambientBlob: 'bg-blue-600/20',
      };
    case 'forest':
      return {
        dark: true,
        base: 'slate',
        accentName: 'emerald',
        appGradientFrom: 'rgba(16,185,129,0.2)',
        appGradientTo: 'rgba(255,255,255,0)',
        ambientBlob: 'bg-emerald-600/15',
      };
    case 'sunset':
      return {
        dark: false,
        base: 'stone',
        accentName: 'orange',
        appGradientFrom: 'rgba(251,146,60,0.15)',
        appGradientTo: 'rgba(255,255,255,0)',
...
const accentMap = {
  indigo: {
    ...
    badge: (d: boolean) =>
      d ? 'bg-indigo-500/20 text-indigo-400' : 'bg-indigo-500/10 text-indigo-600',
  ...
  emerald: {
    ...
    badge: (d: boolean) =>
      d ? 'bg-emerald-500/20 text-emerald-400' : 'bg-emerald-500/10 text-emerald-600',
  ...
  orange: {
    ...
    badge: (d: boolean) =>
      d ? 'bg-orange-500/20 text-orange-400' : 'bg-orange-500/10 text-orange-600',
  ...
  amber: {
    ...
    badge: (d: boolean) =>
      d ? 'bg-amber-500/20 text-amber-400' : 'bg-amber-500/10 text-amber-600',
...
export function getThemeTokens(theme: ThemeMode) {
  ...
  return {
    ...
    surface: {
      ...
      /** Liquid Glass panels */
      glass: d ? 'bg-slate-900/40 backdrop-blur-xl' : 'bg-white/50 backdrop-blur-xl',
      /** Slightly more opaque glass for headers / toolbars */
      glassHeader: d ? 'bg-slate-900/60 backdrop-blur-xl' : 'bg-white/60 backdrop-blur-xl',
      ...
      popover: d ? 'bg-slate-800/95 backdrop-blur-xl' : 'bg-white/95 backdrop-blur-xl',
      /** Subtle inset area */
      ...
      /** Modal container */
      modal: d ? 'bg-slate-900/95 border border-white/8' : 'bg-white/95 border border-slate-200/80',
    },
    ...
    interactive: {
      icon: d ? 'text-slate-500 hover:text-slate-300' : 'text-slate-400 hover:text-slate-600',
      iconBtn: d
      ...
      menuItem: d ? 'hover:bg-slate-700/50 text-slate-300' : 'hover:bg-slate-50 text-slate-600',
