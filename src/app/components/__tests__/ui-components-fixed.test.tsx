...
describe('Dialog Component - Fixed', () => {
  ...
  it('should close dialog', async () => {
    const { Dialog, DialogTrigger, DialogContent, DialogClose, DialogTitle } =
  ...
  it('should have proper ARIA attributes', async () => {
    const { Dialog, DialogTrigger, DialogContent, DialogTitle, DialogDescription } =
      await import('../ui/dialog');
