...
describe('Component Coverage Statistics', () => {
  ...
  it('should have all core components tested', () => {
    const coreComponents = ['IDELayout', 'ChatInterface', 'CodeEditor', 'FileManager', 'PreviewPanel']
  ...
  it('should have all AI components tested', () => {
    const aiComponents = ['ChatInterface', 'AiCodeIntel', 'AiRefactorPanel', 'ModelSettings', 'InlineAIChat']
