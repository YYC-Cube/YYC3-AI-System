...
describe('Menubar Component', () => {
  it('should render menubar', async () => {
    const { Menubar, MenubarMenu, MenubarTrigger, MenubarContent, MenubarItem } = await import('../../components/ui/menubar')
...
describe('Navigation Menu Component', () => {
  it('should render navigation menu', async () => {
    const { NavigationMenu, NavigationMenuList, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuContent, NavigationMenuLink } = await import('../../components/ui/navigation-menu')
...
describe('Pagination Component', () => {
  it('should render pagination', async () => {
    const { Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationPrevious, PaginationNext } = await import('../../components/ui/pagination')
  ...
  it('should handle page navigation', async () => {
    const { Pagination, PaginationContent, PaginationItem, PaginationLink } = await import('../../components/ui/pagination')
    ...
    render(
      <Pagination>
        <PaginationContent>
          <PaginationItem>
            <PaginationLink href="#" onClick={handlePageChange}>1</PaginationLink>
          </PaginationItem>
        </PaginationContent>
      </Pagination>
    )
...
describe('Table Component', () => {
  it('should render table', async () => {
    const { Table, TableHeader, TableBody, TableHead, TableRow, TableCell, TableCaption } = await import('../../components/ui/table')
  ...
  it('should support all table elements', async () => {
    const { Table, TableHeader, TableBody, TableFooter, TableHead, TableRow, TableCell, TableCaption } = await import('../../components/ui/table')
...
describe('Sidebar Component', () => {
  it('should render sidebar', async () => {
    const { Sidebar, SidebarContent, SidebarGroup, SidebarGroupLabel, SidebarGroupContent, SidebarMenu, SidebarMenuItem, SidebarMenuButton, SidebarProvider } = await import('../../components/ui/sidebar')
