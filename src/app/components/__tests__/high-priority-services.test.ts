...
const mockAiProvider = {
  ...
  listModels: vi.fn((_providerId: string) =>
...
describe('AI Provider Service - High Priority Coverage', () => {
  ...
  describe('Model Management', () => {
    it('should list models for provider', async () => {
      mockAiProvider.listModels.mockResolvedValueOnce([{ id: 'gpt-4', name: 'GPT-4' }]);
...
const mockQuickActions = {
  getActions: vi.fn(
    () => [] as Array<{ id: string; type: string; category: string; requiresAI?: boolean }>
  ),
  ...
  optimizeCode: vi.fn((_params: unknown) =>
    Promise.resolve({ optimizedCode: '', explanation: '' })
  ),
...
describe('Multi-Instance Service - High Priority Coverage', () => {
  ...
  describe('Instance Management', () => {
    ...
    it('should list instances', async () => {
      mockMultiInstance.listInstances.mockResolvedValueOnce([{ id: 'inst-1', type: 'main' }]);
  ...
  describe('Workspace Management', () => {
    ...
    it('should list workspaces', async () => {
      mockMultiInstance.listWorkspaces.mockResolvedValueOnce([{ id: 'ws-1', name: 'Test' }]);
  ...
  describe('Session Management', () => {
    ...
    it('should list sessions', async () => {
      mockMultiInstance.listSessions.mockResolvedValueOnce([{ id: 'sess-1', type: 'ai-chat' }]);
  ...
  describe('Error Handling', () => {
    it('should handle instance not found', async () => {
      ...
      await expect(mockMultiInstance.closeInstance('invalid')).rejects.toThrow(
        'Instance not found'
      );
    });
    ...
    it('should handle workspace not found', async () => {
      ...
      await expect(mockMultiInstance.activateWorkspace('invalid')).rejects.toThrow(
        'Workspace not found'
      );
    });
