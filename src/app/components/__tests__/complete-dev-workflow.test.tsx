...
describe('Complete Development Workflow Integration', () => {
  ...
  describe('1. File Creation to Deployment Workflow', () => {
    it('should complete full file creation-edit-preview workflow', async () => {
      ...
      await mockSetCurrentFile({ name: 'test.tsx', path: '/test.tsx', content: 'export default App' })
  ...
  describe('2. AI-Assisted Development Workflow', () => {
    it('should complete AI-assisted coding workflow', async () => {
      ...
      const mockGenerateCode = vi.mocked(require('../../services/ai-provider').aiProviderService.generateCode)
      ...
      await mockSetCurrentFile({ name: 'component.tsx', path: '/component.tsx', content: result.code })
    ...
    it('should handle AI service failures gracefully', async () => {
      ...
      const mockGenerateChat = vi.mocked(require('../../services/ai-provider').aiProviderService.generateChat)
  ...
  describe('3. Multi-file Project Workflow', () => {
    ...
    it('should manage file dependencies in project', async () => {
      ...
      await mockSetCurrentFile({ name: 'utils.ts', path: '/utils.ts', content: 'export const helper = () => {}' })
      await mockSetCurrentFile({ name: 'types.ts', path: '/types.ts', content: 'export interface User {}' })
  ...
  describe('4. Offline-Online Sync Workflow', () => {
    it('should handle offline development and sync', async () => {
      ...
      await mockSetCurrentFile({ name: 'offline-file.ts', path: '/offline-file.ts', content: 'developed offline' })
  ...
  describe('5. Collaborative Development Workflow', () => {
    it('should support collaborative editing workflow', async () => {
      ...
      await mockSetCurrentFile({ name: 'shared.ts', path: '/shared.ts', content: 'const shared = true' })
