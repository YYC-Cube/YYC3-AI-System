...
const mockAiServices = {
  ...
  listProviders: vi.fn(() => Promise.resolve([
    { id: 'openai', name: 'OpenAI', displayName: 'OpenAI', type: 'cloud', baseURL: 'https://api.openai.com/v1', apiKey: '', models: [{ id: 'gpt-4', name: 'GPT-4' }], enabled: true, priority: 1 },
    { id: 'anthropic', name: 'anthropic', displayName: 'Anthropic', type: 'cloud', baseURL: 'https://api.anthropic.com/v1', apiKey: '', models: [{ id: 'claude-3', name: 'Claude 3' }], enabled: true, priority: 2 },
  ])),
  ...
  executeAction: vi.fn((_actionId: string, _params: unknown) => Promise.resolve({ success: true, result: 'optimized' })),
