    ...
    it('应该显示工具栏', async () => {
      render(
        <div data-testid="toolbars">
          <div className="left-toolbar" data-testid="left-toolbar">
            Left
          </div>
          <div className="middle-toolbar" data-testid="middle-toolbar">
            Middle
          </div>
          <div className="right-toolbar" data-testid="right-toolbar">
            Right
          </div>
        </div>
      );
    ...
    it('应该支持面板宽度调整', async () => {
      const { container } = render(
        <div data-testid="resizable-panels">
          <div className="panel" style={{ width: '35%' }}>
            Left
          </div>
    ...
    it('应该显示拖放区域', async () => {
      const { container } = render(
        <div data-testid="drop-zones">
          <div className="drop-zone left" data-testid="drop-left">
            左
          </div>
          <div className="drop-zone middle" data-testid="drop-middle">
            中
          </div>
          <div className="drop-zone right" data-testid="drop-right">
            右
          </div>
        </div>
      );
      ...
      render(
        <div data-testid="theme-picker">
          ...
          <div className="theme-options">
            ...
            <div className="theme-option" data-theme="cyber">
              赛博朋克
            </div>
          </div>
        </div>
    ...
    it('应该显示工具按钮', async () => {
      render(
        <div data-testid="tool-buttons">
          <button data-testid="ai-btn" className="tool-btn active">
            AI
          </button>
          <button data-testid="settings-btn" className="tool-btn">
            设置
          </button>
        </div>
      );
...
describe('面板拖拽功能', () => {
  describe('拖拽交互', () => {
    it('应该支持拖拽开始', async () => {
      ...
      render(
        <div data-testid="drag-start" draggable onDragStart={handleDragStart}>
          可拖拽元素
        </div>
      );
    ...
    it('应该支持拖拽进入', async () => {
      ...
      render(
        <div data-testid="drag-enter" onDragEnter={handleDragEnter}>
          放置区域
        </div>
      );
    ...
    it('应该支持拖拽悬停', async () => {
      ...
      render(
        <div data-testid="drag-over" onDragOver={handleDragOver}>
          放置区域
        </div>
      );
    ...
    it('应该支持放置', async () => {
      ...
      render(
        <div data-testid="drop" onDrop={handleDrop}>
          放置区域
        </div>
      );
...
describe('响应式布局', () => {
  ...
  describe('触摸支持', () => {
    it('应该支持触摸滑动', async () => {
      ...
      render(
        <div data-testid="touch-swipe" onTouchStart={() => {}} onTouchEnd={handleSwipe}>
          可滑动
        </div>
      );
    ...
    it('应该支持双指缩放', async () => {
      ...
      render(
        <div data-testid="pinch-zoom" onWheel={handlePinch}>
          可缩放
        </div>
      );
