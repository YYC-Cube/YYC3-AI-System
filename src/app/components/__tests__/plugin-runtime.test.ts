...
const mockPluginRuntime = {
  // Plugin Lifecycle
  register: vi.fn((_manifest: unknown) => ({
    id: 'plugin-1',
    manifest: {},
    activated: false,
    status: 'inactive',
...
describe('Plugin Runtime Service - Full Coverage', () => {
  ...
  describe('Plugin Registration', () => {
    ...
    it('should validate plugin manifest', () => {
      ...
      mockPluginRuntime.register.mockReturnValueOnce({
        id: 'plugin-1',
        manifest,
        activated: false,
        status: 'inactive',
  ...
  describe('Plugin Management', () => {
    it('should get plugin by ID', () => {
      mockPluginRuntime.getPlugin.mockReturnValueOnce({
        id: 'plugin-1',
        manifest: {},
        activated: true,
        status: 'active',
  ...
  describe('Plugin Execution', () => {
    ...
    it('should handle execution errors', async () => {
      ...
      await expect(mockPluginRuntime.executeAction('invalid', {})).rejects.toThrow(
        'Execution failed'
      );
    });
  });
  ...
  describe('Error Handling', () => {
    ...
    it('should handle permission denied', async () => {
      ...
      await expect(mockPluginRuntime.executeAction('restricted', {})).rejects.toThrow(
        'Permission denied'
      );
    });
