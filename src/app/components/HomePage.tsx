...
export function HomePage() {
    ...
    const handler = (e: globalThis.KeyboardEvent) => {
      ...
      if (ctrl && shift) {
        switch (e.key.toLowerCase()) {
          ...
          case 'p':
            e.preventDefault();
            togglePanel(setShowProjects, showProjects);
            break;
          case 'n':
            e.preventDefault();
            togglePanel(setShowNotifications, showNotifications);
            break;
          case 'g':
            e.preventDefault();
            togglePanel(setShowGithub, showGithub);
            break;
          case 's':
            e.preventDefault();
            togglePanel(setShowShare, showShare);
            break;
          case 'd':
            e.preventDefault();
            togglePanel(setShowDeploy, showDeploy);
            break;
          case 'q':
            e.preventDefault();
            togglePanel(setShowQuickActions, showQuickActions);
            break;
        }
      }
      if (ctrl && !shift && e.key === ',') {
  ...
  return (
    <div
      className={`min-h-screen w-screen flex flex-col font-sans overflow-hidden ${t.transition} ${t.surface.app} ${t.surface.appGradient}`}
    >
      {/* Hidden file inputs */}
      <input
        ref={imageInputRef}
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className={`absolute top-[-20%] left-[30%] w-[600px] h-[600px] rounded-full blur-[120px] ${t.palette.ambientBlob}`}
        />
        <div
          className={`absolute bottom-[-10%] right-[20%] w-[500px] h-[500px] rounded-full blur-[100px] ${t.isDark ? 'bg-cyan-600/10' : 'bg-cyan-400/15'}`}
        />
        <div
          className={`absolute top-[40%] left-[-5%] w-[400px] h-[400px] rounded-full blur-[80px] ${t.isDark ? 'bg-purple-600/8' : 'bg-purple-400/10'}`}
        />
      </div>
        ...
        <div className="flex items-center space-x-1.5">
          ...
          <div className="relative">
            <button
              ...
              aria-label={i.projects}
              title={`${i.projects} (Ctrl+Shift+P)`}
            >
                ...
                <div className={`${popoverClass} right-0 top-full mt-2 w-80`}>
                  ...
                  <div className={`px-4 py-2 border-t ${t.border.subtle}`}>
                    <button
                      ...
                      className={`w-full flex items-center justify-center space-x-1.5 py-1.5 rounded-lg text-[12px] ${t.transition} ${t.interactive.menuItem}`}
          ...
          <div className="relative">
            <button
              ...
              title={`${i.notifications} (Ctrl+Shift+N)`}
            >
                    ...
                    {notifications.map((n) => (
                      ...
                      >
                        <div className="flex items-center space-x-2.5">
                          ...
                          <span
                            className={`text-[12px] ${n.read ? t.text.muted : t.text.secondary}`}
                          >
                            {i[n.textKey]}
                          </span>
                        </div>
                ...
                <div className={`${popoverClass} right-0 top-full mt-2 w-56 p-1.5`}>
                  ...
                  {[
                    ...
                    },
                    {
                      label: i.githubPush,
                      icon: Upload,
                      action: () => toast.success(i.toastCodePushed),
                    },
                    {
                      label: i.githubPull,
                      icon: Download,
                ...
                <div className={`${popoverClass} right-0 top-full mt-2 w-56 p-1.5`}>
                  ...
                  {[
                    ...
                    },
                    {
                      label: i.shareInvite,
                      icon: Mail,
                      action: () => toast.info(i.toastInviteSent),
                    },
                    {
                      label: i.shareExport,
                      icon: Download,
                    ...
                    },
                    {
                      ...
                      action: () => {
                        navigator.clipboard.writeText(
                          '<iframe src="https://yyc3.app/embed"></iframe>'
                        );
          ...
          <div className="relative">
            <button
              ...
              aria-label={i.quickActions}
              title={`${i.quickActions} (Ctrl+Shift+Q)`}
            >
                ...
                <div className={`${popoverClass} right-0 top-full mt-2 w-56 p-1.5`}>
                  ...
                  {[
                    ...
                    >
                      ...
                      {shortcut && (
                        <span className={`text-[9px] ${t.text.dimmed}`}>{shortcut}</span>
                      )}
                    </button>
                  ))}
                </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 pb-8">
        ...
        >
          <div
            className={`relative rounded-2xl overflow-hidden ${t.isDark ? 'bg-slate-900/60 border border-white/10 shadow-2xl' : 'bg-white/70 border border-slate-200/60 shadow-xl'} backdrop-blur-xl`}
          >
            ...
            <AnimatePresence>
              {showCommands && (
                ...
                >
                  <div
                    className={`px-3 py-2 text-[11px] uppercase tracking-wider ${t.text.muted}`}
                    style={{ fontWeight: 600 }}
                  >
                    {i.slashCommands}
                  </div>
            ...
            <div
              className={`flex items-center justify-between px-4 py-2.5 border-t ${t.border.subtle}`}
            >
          ...
          <div className="flex items-center justify-center mt-3 space-x-4">
            ...
            <span className={`text-[11px] ${t.text.muted}`}>
              <kbd className={`px-1.5 py-0.5 rounded text-[10px] ${t.kbd}`}>Shift+Enter</kbd>{' '}
              {i.shiftEnterNewline}
            </span>
            <span className={`text-[11px] ${t.text.muted}`}>
              <kbd className={`px-1.5 py-0.5 rounded text-[10px] ${t.kbd}`}>/</kbd>{' '}
              {i.slashShortcut}
            </span>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-4 px-1">
            <div className="flex items-center space-x-2">
              ...
              <span className={`text-[13px] ${t.text.tertiary}`} style={{ fontWeight: 500 }}>
                {i.recentProjects}
              </span>
            </div>
            <button
              onClick={() => navigate('/ide')}
              className={`flex items-center space-x-1 text-[12px] px-3 py-1.5 rounded-lg ${t.transition} ${t.interactive.headerBtn}`}
              style={{ fontWeight: 500 }}
            >
              <span>{i.viewAll}</span>
              <ChevronRight className="w-3.5 h-3.5" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {recentProjects.map((project) => (
              ...
              >
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        ...
                        setProjectContextMenu(
                          projectContextMenu?.id === project.id
                            ? null
                            : { id: project.id, x: e.clientX, y: e.clientY }
                        );
                      }}
                    >
                ...
                <h3 className="text-[13px] mb-1 truncate" style={{ fontWeight: 600 }}>
                  {project.name}
                </h3>
                <p className={`text-[11px] mb-3 ${t.text.muted}`}>
                  {resolveKey(i, project.description)}
                </p>
        ...
        <>
          ...
          >
            {[
              ...
              {
                label: i.renameProject,
                icon: Edit3,
                action: () => {
                  toast.info(i.toastRenameTriggered);
                  setProjectContextMenu(null);
                },
              },
              {
                ...
                icon: Archive,
                action: () => {
                  toast.success(i.toastProjectArchived);
                  setProjectContextMenu(null);
                },
              },
              {
            ...
            <button
              ...
              className={`w-full flex items-center space-x-2.5 px-3 py-2 text-[12px] rounded-lg ${t.transition} text-red-400 hover:bg-red-500/10`}
              style={{ fontWeight: 400 }}
            >
              <Trash2 className="w-3.5 h-3.5" />
              <span>{i.deleteProject}</span>
            </button>
          </div>
        </>
      )}
