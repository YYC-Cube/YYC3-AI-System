...
function generateMockOps(): ReplayOperation[] {
  ...
  const events: {
  ...
  }[] = [
    {
      ...
      line: 1,
      col: 1,
      content: 'Opened ChatInterface.tsx',
    },
    {
      dt: 5000,
      uid: 0,
      ...
      line: 56,
      col: 1,
      content: 'Navigated to ChatInterface component',
    },
    {
      dt: 8000,
      uid: 1,
      ...
      line: 1,
      col: 1,
      content: 'Alice opened ChatInterface.tsx',
    },
    {
      dt: 12000,
      uid: 1,
      ...
      line: 33,
      col: 7,
      content: 'Alice moved to scrollRef declaration',
    },
    {
      dt: 18000,
      uid: 0,
      ...
      line: 57,
      col: 3,
      content: 'const [isStreaming, setIsStreaming] = useState(false)',
    },
    {
      dt: 25000,
      uid: 1,
      ...
      line: 88,
      col: 3,
      content: 'Selected processSlashCommand function',
      endLine: 100,
      endCol: 4,
    },
    {
    ...
    },
    {
      ...
      line: 35,
      col: 23,
      content: 'Bob navigated to initialDesignRoot',
    },
    {
      dt: 42000,
      uid: 1,
      ...
      line: 88,
      col: 3,
      content: 'Deleted old switch statement (lines 88-100)',
    },
    {
      dt: 48000,
      uid: 1,
    ...
    },
    {
      ...
      line: 35,
      col: 23,
      content: 'designRoot: createDefaultDesignRoot()',
    },
    {
      dt: 60000,
      uid: 3,
    ...
    },
    {
      ...
      line: 7,
      col: 10,
      content: 'Dave navigated to RouterProvider',
    },
    {
      dt: 82000,
      uid: 0,
      ...
      line: 112,
      col: 1,
      content: 'Moved to return statement',
    },
    {
      dt: 90000,
      uid: 1,
    ...
    },
    {
      ...
      line: 5,
      col: 1,
      content: "import { createDefaultDesignRoot } from './defaults'",
    },
    {
      dt: 110000,
      uid: 0,
      ...
      line: 102,
      col: 3,
      content: 'Selected simulateAIResponse function',
      endLine: 109,
      endCol: 4,
    },
    {
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className={`w-8 h-8 rounded-xl flex items-center justify-center ${t.isDark ? 'bg-gradient-to-br from-cyan-500/20 to-violet-500/20' : 'bg-gradient-to-br from-cyan-50 to-violet-50'}`}
              >
                <Radio
                  className={`w-4 h-4 ${playing ? 'text-red-400 animate-pulse' : t.isDark ? 'text-cyan-400' : 'text-cyan-500'}`}
                />
              </div>
              <div>
                ...
                <p className={`text-[10px] ${t.text.dimmed}`}>
                  {i.rtSubtitle} · {operations.length} {i.rtOperation}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              {(playing || currentIndex >= 0) && (
                <span
                  className={`flex items-center gap-1 text-[9px] px-2 py-0.5 rounded-full ${t.isDark ? 'bg-amber-500/15 text-amber-400' : 'bg-amber-50 text-amber-600'}`}
                >
          ...
          <div className={`px-6 py-3 border-b ${t.border.subtle}`}>
            {/* Progress bar */}
            <div
              className={`relative h-2 rounded-full overflow-hidden mb-3 cursor-pointer ${t.isDark ? 'bg-white/[0.06]' : 'bg-slate-100'}`}
              onClick={(e) => {
            ...
            >
              ...
              {operations.map((op, idx) => {
                const pct =
                  totalDuration > 0
                    ? ((op.timestamp - operations[0].timestamp) / totalDuration) * 100
                    : 0;
                return (
                  <div
                    key={op.id}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <button
                  ...
                  title={i.rtJumpToStart}
                >
                  <SkipBack className="w-3.5 h-3.5" />
                </button>
                <button
                  onClick={() => jumpTo(Math.max(0, currentIndex - 5))}
                  className={`p-1.5 rounded-lg ${t.transition} ${t.interactive.iconBtn}`}
                  title={i.rtRewind}
                >
                ...
                <button
                  onClick={() => jumpTo(Math.min(operations.length - 1, currentIndex + 5))}
                  className={`p-1.5 rounded-lg ${t.transition} ${t.interactive.iconBtn}`}
                  title={i.rtForward}
                >
                ...
                <button
                  onClick={() => jumpTo(operations.length - 1)}
                  className={`p-1.5 rounded-lg ${t.transition} ${t.interactive.iconBtn}`}
                  title={i.rtJumpToEnd}
                >
                ...
                <div className="relative">
                  ...
                  {showSpeedMenu && (
                    <div
                      className={`absolute bottom-full left-0 mb-1 rounded-lg overflow-hidden ${t.surface.popover} ${t.border.popover} shadow-xl z-10`}
                    >
                      {SPEED_OPTIONS.map((s) => (
                        <button
                          key={s}
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-0.5 flex-shrink-0 pt-0.5">
                    <div
                      ...
                      style={{
                        borderColor: op.userColor,
                        backgroundColor: isPast ? op.userColor : 'transparent',
                      }}
                    />
                    {idx < filteredOps.length - 1 && (
                      <div
                        className={`w-px flex-1 min-h-[16px] ${t.isDark ? 'bg-white/[0.06]' : 'bg-slate-200'}`}
                      />
                    )}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        ...
                        style={{ color: op.userColor, fontWeight: 500 }}
                      >
                        {op.userName}
                      </span>
