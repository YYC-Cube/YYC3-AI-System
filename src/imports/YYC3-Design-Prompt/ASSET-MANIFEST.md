---
file: ASSET-MANIFEST.md
description: YYC³ Design Prompt - 资源清单，包含目录结构和文件列表
author: YanYuCloudCube Team <admin@0379.email>
version: v1.0.0
created: 2026-03-15
updated: 2026-03-20
status: stable
tags: manifest,assets,structure,zh-CN
category: project
language: zh-CN
project: yyc3-design-prompt
phase: documentation
audience: developers
complexity: basic
---
...
# YYC3 Design Prompt - Asset Manifest

> Pulled from: https://github.com/YY-Nexus/YanYuCloud/tree/main/YYC3-Design-Prompt
> Date: 2026-03-15
...
```
YYC3-Design-Prompt/
|-- 变量词库/                          (4 files - ALL DOWNLOADED)
|   |-- YYC3-变量-品牌标识.md           -> /src/imports/YYC3-Design-Prompt/变量词库/
|   |-- YYC3-变量-技术栈版本.md
|   |-- YYC3-变量-配置参数.md
|   |-- YYC3-变量-项目信息.md
|
|-- P0-核心架构/                        (6 files - ALL FETCHED)
|   |-- YYC3-P0-架构-项目初始化.md
|   |-- YYC3-P0-架构-宿主机桥接.md
|   |-- YYC3-P0-架构-本地存储.md
|   |-- YYC3-P0-架构-目录结构.md
...
|
|-- P5-审核交付/                        (1 file - DOWNLOADED)
|   |-- YYC3-全量收尾交互提示词.md
|
|-- public/yyc3-yy/                    (ICON ASSETS - URLs below)
    |-- Android/
    |   |-- Play Store.png (512x512)
    |   |-- hdpi.png (72x72)
    |   |-- mdpi.png (48x48)
    |   |-- xhdpi.png (96x96)
    |   |-- xxhdpi.png (144x144)
    ...
    |
    |-- iOS/
    |   |-- App Store.png (1024x1024)
    |   |-- iPad App.png
    |   |-- iPad Notification.png
    |   |-- iPad Pro App 2x.png
    |   |-- iPad Settings.png
    |   |-- iPad Spotlight.png
    |   |-- iPhone App 2x.png
...
- **Total icon assets**: ~30+ (across Android/iOS/macOS/Web App/watchOS)
- **Total content size**: ~730KB+ (markdown only)
- **Repository commit**: e321987d83cd678595f8c9f5a1d8e83a4828cea1
